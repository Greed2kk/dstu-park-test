 ...
 */
     ...
     //координаты маркеров
     L.marker([47.2401, 39.71065], {
         icon: treeIcon
     }).bindPopup("<b>Парк ДГТУ</b><br/>Студенческий парк").addTo(mymap);
     L.marker([47.24097, 39.70935], {
         icon: sportIcon
     }).bindPopup("<b>Манеж ДГТУ</b><br/>").addTo(mymap);
     L.marker([47.23882, 39.71025], {
         icon: footballIcon
     }).bindPopup("<b>Футбольное поле</b><br/>Поле для мини-футбола").addTo(mymap);
     L.marker([47.23936, 39.71274], {
         icon: bedIcon
     }).bindPopup("<b>Общежитие ДГТУ</b><br/>Место временного проживания иногородних студентов").addTo(mymap);
     L.marker([47.23876, 39.71099], {
         icon: pooltIcon
     }).bindPopup("<b>Бассеин ДГТУ</b>").addTo(mymap);
     L.marker([47.23942, 39.70906], {
         icon: runIcon
     }).bindPopup("<b>Поле для бега</b>").addTo(mymap);
     L.marker([47.23883, 39.71148], {
         icon: volleyballIcon
     }).bindPopup("<b>Волейбольный зал ДГТУ</b><br/>Зал для тренеровок студентов ДГТУ").addTo(mymap);
